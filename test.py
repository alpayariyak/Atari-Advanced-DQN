...
def test(agent, env, total_episodes=30, record_video=False):
    ...
    Args:
        ...
        record_video: (bool) whether to record a video of the testing process.
...
def run(args, render_mode=None, record_video=False):
    ...
    """
    env = Environment('BreakoutNoFrameskip-v4', args, atari_wrapper=True, test=True, render_mode=render_mode)
