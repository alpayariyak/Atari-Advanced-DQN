def add_arguments(parser):
    ...
    parser.add_argument('--target_update_interval', type=int, default=10000, help='target_update_interval')
    parser.add_argument('--evaluate_interval', type=int, default=10000, help='evaluate_interval')

    parser.add_argument('--initialize_weights', type=bool, default=True, help='Initialize manually or pytorch')
    parser.add_argument('--clip_grad', type=bool, default=True, help='to clip grads or not')
    parser.add_argument('--load_checkpoint', type=int, default=False, help='')

    parser.add_argument('--test_n', type=int, default=False, help='a')
    return parser
